...
class UserInterface(tk.Frame):
	...
	#Publishers
	self.hydrophones_publisher = rospy.Publisher('hydro_new_data', Hydrophones, queue_size=10)
	self.imu_publisher = rospy.Publisher('imu_new_data', IMU, queue_size=10)
	self.dvl_publisher = rospy.Publisher('dvl_new_data', DVL, queue_size=10)
	self.sonar_publisher = rospy.Publisher('sonar_new_data', Sonar, queue_size=10)
	self.barometer_publisher = rospy.Publisher('barometer_new_data', Barometer, queue_size=10)
