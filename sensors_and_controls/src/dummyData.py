...
from sensing_and_controls.msg import sensors_controls_data

while True:
	rospy.init_node('sensors_and_controls')
	publisher = rospy.Publisher('sensor_and_controls_data', sensors_control_data, queue_size=10)


	rate = rospy.Rate(10)
	data = sensor_controls_data()
