...
message(STATUS "ez_async_data: 5 messages, 0 services")

set(MSG_I_FLAGS "-Iez_async_data:/home/carl/robosub_repo/src/sensing_and_actuation/ez_async_data/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/carl/robosub_repo/src/sensing_and_actuation/ez_async_data/msg/CV.msg" NAME_WE)
add_custom_target(_ez_async_data_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ez_async_data" "/home/carl/robosub_repo/src/sensing_and_actuation/ez_async_data/msg/CV.msg" ""
)

get_filename_component(_filename "/home/carl/robosub_repo/src/sensing_and_actuation/ez_async_data/msg/gate.msg" NAME_WE)
add_custom_target(_ez_async_data_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ez_async_data" "/home/carl/robosub_repo/src/sensing_and_actuation/ez_async_data/msg/gate.msg" ""
)

get_filename_component(_filename "/home/carl/robosub_repo/src/sensing_and_actuation/ez_async_data/msg/Rotation.msg" NAME_WE)
add_custom_target(_ez_async_data_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ez_async_data" "/home/carl/robosub_repo/src/sensing_and_actuation/ez_async_data/msg/Rotation.msg" ""
)

get_filename_component(_filename "/home/carl/robosub_repo/src/sensing_and_actuation/ez_async_data/msg/Barometer.msg" NAME_WE)
add_custom_target(_ez_async_data_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ez_async_data" "/home/carl/robosub_repo/src/sensing_and_actuation/ez_async_data/msg/Barometer.msg" ""
)

get_filename_component(_filename "/home/carl/robosub_repo/src/sensing_and_actuation/ez_async_data/msg/test.msg" NAME_WE)
add_custom_target(_ez_async_data_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ez_async_data" "/home/carl/robosub_repo/src/sensing_and_actuation/ez_async_data/msg/test.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ez_async_data)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ez_async_data\")")
  # install generated code
  install(
